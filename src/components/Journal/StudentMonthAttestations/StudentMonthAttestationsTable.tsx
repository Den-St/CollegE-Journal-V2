...
import { StudentMonthAttestationTableT, useGetStudentMonthAttesationsTable } from "../../../hooks/getStudentMonthAttestations";

export const StudentMonthAttesationsTable = () => {
    const {table,loading,} = useGetStudentMonthAttesationsTable();
...
type TeachersProps = {
    table:StudentMonthAttestationTableT,
    dragScroll:{
