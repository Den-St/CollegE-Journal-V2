...
export const useAbsenceTableDragScroll = () => {
    ...
    const handleHorizontalScroll = (elementName:"cells" | "lessonTypes" | "teachers" | "subjects") => {
        if(lessonTypesRef.current === null || cellsRef.current === null || teachersRef.current === null || subjectsRef.current === null) return;
        if(elementName === "cells"){
            ...
            subjectsRef.current.scrollLeft = cellsRef.current.scrollLeft;
            ...
            subjectsRef.current.scrollLeft = lessonTypesRef.current.scrollLeft;
            ...
            cellsRef.current.scrollLeft = subjectsRef.current.scrollLeft;
            lessonTypesRef.current.scrollLeft = subjectsRef.current.scrollLeft;
    ...
    return {cellsRef,lessonTypesRef,mainContainerRef,mousePos,onMouseMove,mouseUpHandler,
           ...
           handleVerticalScroll,teachersRef,subjectsRef}
}